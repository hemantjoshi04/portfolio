      ...
      <AuthProvider>
        <Routes>
          ...
          <Route element={<ProtectedRoute><AdminLayout /></ProtectedRoute>}>
            ...
            <Route path="/admin/blog" element={<div className="p-gutter lg:p-12"><h1 className="font-headline-sm text-headline-sm text-primary mb-4">Blog Manager</h1><p className="font-body-md text-on-surface-variant">Coming soon.</p></div>} />
